...
def train_val_test_split():
    ...
    #BERT4Rec-style split (consistent with your collator)
    ...
    write_sequences(VAL_DIR / "input.txt", val_input)
    write_labels(VAL_DIR / "output.txt", val_gt)
    write_sequences(TEST_DIR / "input.txt", test_input)
    write_labels(TEST_DIR / "output.txt", test_gt)
